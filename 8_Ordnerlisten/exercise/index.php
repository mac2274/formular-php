...
foreach($verzeichnisInhalt as $datei){
    if($datei != "." && $datei != ".."){
        ...
        if(is_file($pfad) && in_array(pathinfo($datei, PATHINFO_EXTENSION), $erlaubteDateien)){
            echo "<img style='width:100px;height:auto;' src='$datei' alt='$datei'><br>"; //hier habe ich den Pfad mit $pfad angegeben, aber hier musst $datei, also der relative Dateiname rein
